...
public class PerjalananSementara extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    InitAnggota initAnggota;
    InitPerjalanan initPerjalanan;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btn_perjalanan:
                ...
                initPerjalanan  = new InitPerjalanan(dialog);
            ...
            case R.id.btn_anggota_perjalanan:
                ...
                initAnggota = new InitAnggota(dialog);
